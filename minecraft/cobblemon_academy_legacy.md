...
- modpack : https://www.curseforge.com/minecraft/modpacks/cobblemon-academy
  ...
  - come bundled with the corect fabric server jar file
- Work with Java 21 : https://adoptium.net/fr/temurin/releases
  - Take the LTS version
- just start the fabric jar with Java
...
## Lootr
- reset chest content : `/lootr clear <player name>`

## Cobblemon
- configure spawn rate (TODO)
