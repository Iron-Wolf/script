...
gitGraph TB:
  ...
  checkout Valve
  commit id:"Steam Linux (V1) efef" tag:"2013-02-14"
  commit id:"SteamOS (V1)" tag:"2013-12-13"

  checkout Vulkan
  commit id:"Vulkan API (V1)" tag:"2016-02-16"
  commit id:"VKD3D (1er commit)" tag:"2016-09-21"
  commit id:"DXVK (1er commit)" tag:"2017-10-10"

  checkout Valve
  commit id:"Steam Play (Proton)" tag:"2018-01-18"

  checkout Vulkan
  commit id:"Zink (annonce)" tag:"2018-10-31"

  checkout Valve
  commit id:"ACO" tag:"2019-07-03"

  checkout Vulkan

  checkout Valve
  commit id:"Compatibilité EAC" tag:"2021-09-23"
  commit id:"Compatibilité BattleEye" tag:"2021-11-06"
  commit id:"Steam Deck" tag:"2022-02-25"
